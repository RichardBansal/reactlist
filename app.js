...
var FilterItems = React.createClass({
    ...
    loadFiltersFromServer: function loadFiltersFromServer() {
    ...
    getInitialState: function getInitialState() {
        //these are filters being loaded, not selected
        return { filters: [] };
    },
...
var FilterInput = React.createClass({
    ...
    handleUserInput: function handleUserInput() {
        this.props.onUserInput(this.refs.filterTextInput.getDOMNode().value, undefined);
    },
    render: function render() {
...
var FilterOptions = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                'select',
                { onChange: this.handleUserInput, value: this.state.value },
...
var FilteredResults = React.createClass({
    ...
    loadAllCitiesFromServer: function loadAllCitiesFromServer() {
        ajaxServerRequest().then(fulfilled);
        var self = this;
        function fulfilled(response) {
