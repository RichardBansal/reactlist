...
var FilterMenu = React.createClass({displayName: "FilterMenu",
	...
	var FilterItems = React.createClass({displayName: "FilterItems",
		...
		handleChange: function(){
            console.log(this.refs.filterTextInput.getDOMNode().value,this.refs.foo.getDOMNode().value);
			this.props.onUserInput(
				this.refs.filterTextInput.getDOMNode().value,
				this.ref.filterName.refs.foo.getDOMNode().value
			);
		},
		render: function(){
				...
				React.createElement("div", {className: "FilterItems"}, 
                        ...
                        React.createElement("select", {
                            ...
                            ref: "filterName"
                                ...
                                React.createElement("option", {ref: "foo"}, "Foo"), 
                                React.createElement("option", {ref: "bar"}, "Bar"), 
                                React.createElement("option", {ref: "baz"}, "Baz")
                        )
				)
				)
		}
