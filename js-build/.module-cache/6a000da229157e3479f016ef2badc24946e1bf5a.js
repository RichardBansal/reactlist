...
var FilterMenu = React.createClass({displayName: "FilterMenu",
	...
	var FilterItems = React.createClass({displayName: "FilterItems",
		...
		render: function(){
			...
			//	return( <option value={tempCost} ref="filterOptionsInput" key={index}>
             //               {tempCost}
             //           </option>)
			//});
            ...
            //TODO:{Cost}
            //required to reference this in FilterItems
			var FilterItems = this.state.filters.map(function(filter, index){
				return (
					React.createElement("div", null, 
                        React.createElement("span", {value: filter, ref: "filterName", key: index}, filter), 
						React.createElement("select", null, 
                            React.createElement("option", {ref: "filterOptionsInput"}, "1000"), 
                            React.createElement("option", {ref: "filterOptionsInput"}, "2000")
						)
					)
					)
			});
			...
			return (
				React.createElement("div", {className: "FilterItems"}, 
					React.createElement("h3", null, "Filter Items"), 
                        ...
                        React.createElement("div", {onChange: this.handleChange}, 
                            React.createElement("select", {ref: "filterName"}, 
                                React.createElement("option", {ref: "filterOptionsInput"}, "1000"), 
                                React.createElement("option", {ref: "filterOptionsInput"}, "1500")
                            )
                        )
