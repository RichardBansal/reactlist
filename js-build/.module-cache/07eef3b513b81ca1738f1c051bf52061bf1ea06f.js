        ...
        var FilteredResults = React.createClass({displayName: "FilteredResults",
            ...
            render: function(){
                ...
                var searchResult = this.state.citydata.filter(function(city){
                    console.log(city);
                    console.log('380.render.FilteredResutls',city['data-apartment-cost'] < 500, self.props.selectedOptions);
                    return (
                            city['data-name'] === self.props.filterText ||
                            parseInt(city[self.props.selectedOptions.filter]) < self.props.selectedOptions
                            );
                });
