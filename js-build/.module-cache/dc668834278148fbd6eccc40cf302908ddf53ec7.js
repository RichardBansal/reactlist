	...
	var FilterItems = React.createClass({displayName: "FilterItems",
		...
		handleChange: function(){
			...
			this.props.onUserInput(
				...
				'' //TODO: Revert back and grab all TODOs from copy_code.js
			);
		},
		render: function(){
			...
			return (
				React.createElement("div", {className: "FilterItems"}, 
                        ...
                        React.createElement("select", {defaultValue: "Select"}, 
                            React.createElement("option", null, "Foo"), 
                            React.createElement("option", null, "Bar"), 
                            React.createElement("option", null, "Baz")
                        )
				)
				)
		}
