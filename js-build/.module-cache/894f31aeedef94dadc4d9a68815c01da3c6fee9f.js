...
var DataFilters = [{filterName: "Cost of living", filterValues: ["500","1000","1500","2000","3000","5000"]},
    {filterName: "Apartment cost", filterValues: ["125","250","500","1000","2000"]},
    {filterName: "Hotel Cost", filterValues: ["3","5","10","25","50"]},
    {filterName: "Nomad cost", filterValues: ["500","1000","1500","2000","3000","5000"]}
];
        ...
        var FilterItems = React.createClass({displayName: "FilterItems",
            ...
            var FilterDropDown = React.createClass({displayName: "FilterDropDown",
                ...
                render:function(){
                    ...
                    var FilterArr = ['apples','oranges','banana'].map(function(filterName){
                        return (React.createElement(FilterOptions, {
                                selectedOptions: this.props.selectedOptions, 
                                onUserInput: this.handleUserInput, 
                ...
                var FilterOptions = React.createClass({displayName: "FilterOptions",
                    ...
                    handleUserInput: function(event){
                        console.log(event.target.value, this.props.filterName);
                        this.setState({value:event.target.value});
                        this.props
                            .onUserInput
                                    (
