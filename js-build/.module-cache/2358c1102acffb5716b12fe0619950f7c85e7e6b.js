        ...
        var FilteredResults = React.createClass({displayName: "FilteredResults",
            ...
            render: function(){
                ...
                var searchResult = this.state.citydata.filter(function(city){
                    ...
                    //if()
                    //TODO: Only allowe search or filter, not both yet
                    if(self.props.selectedOptions){
                        ...
                        var tempArr = self.props.selectedOptions
                        var result = self.props.selectedOptions.all(function(filterObj){
                            return (city[filterObj.filter] < filterObj.value)
                        });
                        console.log(result);
                        return (
