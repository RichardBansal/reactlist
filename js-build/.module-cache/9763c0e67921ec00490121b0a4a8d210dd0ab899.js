	...
	var FilterItems = React.createClass({displayName: "FilterItems",
		...
		render: function(){
			...
			var Cost = AppartmentCostRange.map(function(cost,index){
                console.log(cost);
				return( React.createElement("option", {value: cost, ref: "filterOptionsInput", key: index}, 
                            cost
                        ))
			}.bind(this));
            ...
            //                {Cost}
				...
				//	)
            //}.bind(this));
            var FilterItems = [].push(
                React.createElement("div", null, 
                    React.createElement("select", null, 
                        React.createElement("span", {value: filter, ref: "filterName"}, "Test"), 
                        Cost
                    )
                )
            );
