            ...
            var FilterDropDown = React.createClass({displayName: "FilterDropDown",
                ...
                var FilterOptions = React.createClass({displayName: "FilterOptions",
                    ...
                    render: function(){
                        ...
                        return (
                            React.createElement("div", null, 
                                React.createElement("select", {onChange: this.change, value: this.state.value}, 
                                AppartmentCostRange.map(function(item, i) {
                                    return (
                                        React.createElement("option", {
                                            value: "item", 
                                            onChange: this.handleUserInput.bind(this, item), 
                                            key: i}, 
                                                item
                                        )
                                    );
