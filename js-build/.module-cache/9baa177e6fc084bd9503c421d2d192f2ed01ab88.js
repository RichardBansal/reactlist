...
var FilterableView = React.createClass({displayName: "FilterableView",
	...
	handleUserInput: function(filterText, selectedOption){
		console.log('57-handleUserInput',filterText, selectedOption);
...
var FilterMenu = React.createClass({displayName: "FilterMenu",
	...
	var FilterItems = React.createClass({displayName: "FilterItems",
		...
		handleChange: function(){
			console.log('128 - handleChange',this.refs.testing123.getDOMNode().value, this.props);
			this.props.onUserInput(
				this.refs.filterTextInput.getDOMNode().value,
				this.refs.filterOptionsInput.getDOMNode().value,
				this.refs.testing123.getDOMNode().value
			);
		},
		render: function(){
				...
				return (
					React.createElement("div", null, 
						React.createElement("select", {
							onClick: this.handleChange, //CHECK: onChange correct, onSelect
			...
			return (
				React.createElement("div", {className: "FilterItems"}, 
					React.createElement("h3", null, "Filter Items"), 
						...
						React.createElement("select", {onChange: this.handleChange, ref: "filterOptionsInput"}, 
							React.createElement("option", {ref: "testing123"}, "1"), 
							React.createElement("option", {ref: "testing456"}, "2")
						)
				)
				)
		}
