            ...
            var FilterDropDown = React.createClass({displayName: "FilterDropDown",
                ...
                var FilterOptions = React.createClass({displayName: "FilterOptions",
                    handleUserInput: function(i){
                        console.log('in FilterOptions handlerUserInput',i);
                    ...
                    render: function(){
                        ...
                        Options = AppartmentCostRange.map(function(item, i) {
                            console.log(item);
                            return (
                                React.createElement("option", {onClick: this.handleUserInput.bind(this, i), key: i}, item)
                            );
                        }, this)

                        return React.createElement("select", {onChange: this.handleUserInput}, 
                                Options
                                )
                    }
                });
