	...
	var FilterItems = React.createClass({displayName: "FilterItems",
		...
		handleChange: function(){
			console.log('!!!145 - filter return',
                        ...
                        this.refs.filterOptionsInput.getDOMNode().innerText,
                        this.refs.filterTextInput.getDOMNode().innerText);
		...
		render: function(){
			...
			var Cost = AppartmentCostRange.map(function(cost,index){
                var tempCost = cost;
				return( React.createElement("option", {value: tempCost, ref: "filterOptionsInput", key: index}, 
                            tempCost
                        ))
			});
