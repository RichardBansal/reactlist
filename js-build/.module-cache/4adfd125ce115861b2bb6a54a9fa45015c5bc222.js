...
var App = React.createClass({displayName: "App",
	render: function(){
		return (
				React.createElement("div", null, 
					React.createElement(NavBar, {className: "firstname"}), 
					React.createElement(FilterMenu, {className: "FilterMenu"}), 
					React.createElement(SelectedView, {className: "SelectedView"})
				)
			)
	}
});
